        ...
        <section className='bio'>
            <div className='bio-photo'>
                <div className='title-content'>
                    ...
                    <a className='bio-content'>Hi there! I'm a full-stack developer with a background in classical music and non-profit fundraising. A gifted writer and communicator, I'm studying coding and software development to expand my ability to meaningfully and creatively interact with mission-driven organizations. Originally from western Massachusetts, I lived in New York City for a number of years and recently relocated to Durham, North Carolina. In addition to pursuing my work as a software developer, I continue to freelance as a classical composer specializing in concert music. 
                    <br></br>
                    <br></br>
